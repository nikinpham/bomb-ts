...
export const LIMITATION_GOD_BADGE = [TILE_TYPE.WALL, TILE_TYPE.PRISON_PLACE, TILE_TYPE.BALK, TILE_TYPE.DESTROYED_CELL];
export const LIMITATION_BALK = [TILE_TYPE.WALL, TILE_TYPE.PRISON_PLACE, TILE_TYPE.BRICK_WALL];
export const LIMITATION_BRICK = [TILE_TYPE.WALL, TILE_TYPE.PRISON_PLACE, TILE_TYPE.BALK];

export const MINIMUM_DISTANCE = 5;
export const TIME_IN_ONE_CELL = 500;
export const DANGER_BOMB_TIME = 530;
